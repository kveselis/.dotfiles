...
values."
  (setq-default
   ...
   '(
     ...
     ;;                ispell-personal-dictionary "c:/Program Files (x86)/Aspell/dict/.dic")
     ;; syntax-checking
     ;; version-control
     ;; python
     (clojure :variables
...
in `dotspacemacs/user-config'."
  ...
  (add-to-list 'exec-path "~/AppData/Roaming/local/bin/")
...
layers configuration. You are free to put any user code."
  ...
  (setq paradox-github-token '84f3f3d1b0353ae52bd247fd6368fe1df03b4a59)
  ...
  (eval-after-load 'tex
    '(progn
       ...
       (push '("%(-PDF)"
               (lambda ()
                 (cond ((equal TeX-engine 'luatex) "-lualatex ")
