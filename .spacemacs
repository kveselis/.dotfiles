...
(defun dotspacemacs/init ()
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Iosevka SS09";"DejaVuSansMono";"PragmataPro";"Source Code Pro";"Monoid HalfLoose";"Consolas";"Input Mono"
                               :size 16
                               :weight medium
                               :width normal)
...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  ;;(load-file "~/.emacs.d/elpa/26.1/dash-20180413.30/dash.el")               ;; not needed in version 3
  ;;(load-file "~/.emacs.d/elpa/26.1/autothemer-20170112.1324/autothemer.el") ;; not needed in version 3

  (set-fontset-font t '(#x2460 . #xF5FF) (font-spec :size 16 :name "Iosevka SS09"))
  ;;(set-fontset-font "fontset-default" '(#x0000 . #xFFFF) (font-spec :size 24 :name "Iosevka SS09"))
...
before packages are loaded."
 ...
 (with-eval-after-load 'web-mode
  ...
  ;;(spacemacs|do-after-display-system-init
   ;(set-fontset-font "fontset-default" '(#x0000 . #xFFFF) (font-spec :size 16 :name "Iosevka SS09"))
